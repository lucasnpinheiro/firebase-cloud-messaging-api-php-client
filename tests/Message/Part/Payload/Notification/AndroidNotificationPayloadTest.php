 ...
 */
class AndroidNotificationPayloadTest extends \PHPUnit_Framework_TestCase
{
    public function testObjectCreation()
    {
        ...
        $this->assertInstanceOf(AbstractNotificationPayload::class, $androidNotificationPayload);
